...
bot.on('message', async message =>
{
    ...
    if (!message.member.roles.cache.find(r => r.name === role_gm) && !message.member.roles.cache.find(p => p.name === role_mayor) && message.member.id != 322045483579211777 && message.member.id != 341304595152109569)
    {
